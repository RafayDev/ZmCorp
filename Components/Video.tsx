...
const Video = () => {
  return (
    <div>
      ...
      <div  className="absolute bg-opacity-50 top-1/4 rounded-lg left-1/2 bg-black transform -translate-x-1/2 w-full -translate-y-4 text-center text-center text-white p-1">
        <h1 className="text-xs sm:text-xl md:text-2xl font-bold lg:text-4xl xl:text-6xl">
          ZM CORP
        </h1>
        <p className=" text-xs mt-1  sm:text-sm md:text-md lg:text-lg xl:text-xl">
